					...
					global $conn;
						if( isset($_POST['submit']) )
													...
													if(strlen($password)<6){
													        ...
													        $insert = "insert into users (user_name,user_pass,user_prog,user_gender,user_pic,user_email,reg_date,last_login,status,posts) values ('$name','$password','$program','$sex','default.png','$email','$date','$date','unverified','Nill' )";
